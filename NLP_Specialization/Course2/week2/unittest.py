    ...
    test_cases = [
        {
            ...
            "input": {
                ...
                "best_probs": pickle.load(
                    open("./files/best_probs_initilized.pkl", "rb")
                ),
                "best_paths": pickle.load(
                    open("./files/best_paths_initilized.pkl", "rb")
                ),
                "vocab": vocab,
                "verbose": False,
            },
    ...
    test_cases = [
        {
            ...
            "input": {
                "corpus": corpus,
                "best_probs": pickle.load(
                    open("./files/best_probs_trained.pkl", "rb")
                ),
                "best_paths": pickle.load(
                    open("./files/best_paths_trained.pkl", "rb")
                ),
                "states": states,
            },
            "expected": {
